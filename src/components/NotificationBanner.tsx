      ...
      {notifications.map((notif) => (
        ...
        >
          <div className="flex items-start gap-3">
            {/* Avatar */}
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#ff655b] to-[#eab84f] flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              {!notif.is_following_back ? (
                <button
                  ...
                  className="flex items-center gap-2 bg-gradient-to-r from-[#ff655b] to-[#eab84f] text-white text-sm font-medium px-3 py-1.5 rounded-lg hover:from-[#ff8175] hover:to-[#f6cd66] transition-all"
                >
