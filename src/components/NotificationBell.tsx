  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] flex items-center justify-center text-[10px] font-bold bg-[#ff655b] text-white rounded-full px-1">
            ...
            <div className="overflow-y-auto flex-1">
              {notifications.length === 0 ? (
                ...
                notifications.map(n => (
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-[#2c3440] flex items-center justify-center text-white font-bold text-sm flex-shrink-0 overflow-hidden">
          ...
          <div className="overflow-y-auto flex-1">
            {notifications.length === 0 ? (
              ...
              notifications.map(n => (
                ...
                >
                  <div className="w-9 h-9 rounded-full bg-[#2c3440] flex items-center justify-center text-white font-bold text-sm flex-shrink-0 overflow-hidden">
                    <UserAvatar avatarUrl={n.from_profile?.avatar_url} avatarCrop={n.from_profile?.avatar_crop} username={n.from_profile?.username ?? '?'} />
                    {!n.from_profile?.avatar_url && (n.from_profile?.username?.[0] ?? '?').toUpperCase()}
                  </div>
                  <div className="flex-1 min-w-0">
