...
export default function EntryEditor({
  ...
  return (
    <dialog
      ...
      className="fixed inset-x-0 bottom-0 top-auto m-0 max-h-[92dvh] w-full max-w-none overflow-y-auto rounded-t-[28px] border border-[#34363a] bg-[#191b1e] p-0 text-[#f4f0e8] shadow-2xl backdrop:bg-black/75 sm:inset-0 sm:m-auto sm:max-w-xl sm:rounded-3xl"
    >
      <div
      ...
      <div className="flex items-center justify-between px-6 pb-3 pt-4">
        <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-[#aba7a1]">
        ...
        <button
          ...
          onClick={onClose}
          disabled={isPending}
          className="flex h-11 w-11 items-center justify-center rounded-full bg-[#232529] text-[#d7d3cc] transition-colors hover:bg-[#303236] disabled:opacity-40"
        >
          <X className="h-5 w-5" />
        </button>
      </div>
      <form onSubmit={saveEntry}>
        <div className="space-y-6 px-6 pb-6">
          <div className="flex items-center gap-4 border-b border-[#34363a] pb-6">
            ...
            <div className="min-w-0">
              ...
              {entry.genre && (
                <p className="mt-2 text-xs text-[#aba7a1]">{entry.genre}</p>
              )}
            </div>
          </div>
          ...
          <fieldset disabled={isPending}>
            ...
            {draft.status !== 'logged' && (
              <p className="mt-3 text-xs leading-relaxed text-[#aba7a1]">
          ...
          {isReviewed && (
            <>
              <fieldset disabled={isPending}>
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="flex h-11 w-11 items-center justify-center rounded-xl border border-[#34363a] bg-[#232529] disabled:opacity-40"
                  >
                  ...
                  <input
                    ...
                    className="h-12 w-20 rounded-xl border border-[#34363a] bg-[#101113] text-center text-2xl font-semibold tabular-nums text-[#f2cc8f] focus:outline-none focus:ring-2 focus:ring-[#ff655b]"
                  />
                  <button
                    type="button"
                    onClick={() => changeRating(0.1)}
                  ...
                  <span className="text-sm text-[#aba7a1]">/ 10</span>
                  {draft.rating > 0 && (
                    <button
                      type="button"
                      onClick={() =>
                      ...
                      className="ml-auto min-h-11 text-xs text-[#aba7a1] underline underline-offset-4"
                    >
                      Clear
                    </button>
                  )}
              ...
              <div>
                ...
                >
                  A few thoughts{' '}
                  <span className="ml-1 font-normal text-[#aba7a1]">
                    (optional)
                  </span>
                </label>
                <textarea
                  ...
                  rows={4}
                  className="w-full resize-y rounded-xl border border-[#34363a] bg-[#101113] px-4 py-3 text-base leading-relaxed placeholder:text-[#817e79] focus:outline-none focus:ring-2 focus:ring-[#ff655b]"
                  placeholder="The moment that stayed with you…"
                />
              </div>
            </>
          )}
          <p className="text-xs text-[#aba7a1]">
            Last updated{' '}
          ...
          {confirmDelete && (
            ...
            >
              ...
              <p className="mt-1 text-sm leading-relaxed text-[#aba7a1]">
              ...
              <div className="mt-4 flex gap-2">
                <button
                  ...
                  disabled={isPending}
                  className="min-h-11 flex-1 rounded-xl border border-[#34363a] px-3 text-sm"
                >
                  Keep entry
                </button>
                <button
        ...
        {!confirmDelete && (
          <div className="sticky bottom-0 flex gap-3 border-t border-[#34363a] bg-[#191b1e] px-6 pb-[max(1.5rem,env(safe-area-inset-bottom))] pt-4">
            <button
              type="button"
              onClick={() => {
                setError(null)
              ...
              className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-[#34363a] text-[#ff918a] disabled:opacity-40"
            >
